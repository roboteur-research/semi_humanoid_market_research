...
**Data-hygiene note (verified 2026-08):** humanoid.guide's "ToraOne" listing (humanoid.guide/product/toraone/) credits "Tokyo Robotics" as manufacturer, but the page's logo, description ("from Paxini") and links point to PaXini Tech (Shenzhen), and its specs match PaXini's TORA-ONE. Tokyo Robotics has no product called ToraOne — the listing is a misattribution; see companies/paxini/tora-one/.
